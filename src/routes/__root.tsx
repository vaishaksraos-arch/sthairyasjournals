...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Evidence-based physiotherapy articles on conditions, treatments, and advances — for patients and clinicians." },
      { property: "og:title", content: "KinetIQ — Physiotherapy Journal" },
      { property: "og:description", content: "Evidence-based physiotherapy articles on conditions, treatments, and advances." },
